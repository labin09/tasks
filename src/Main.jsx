...
const Main = () => {
  ...
  return (
    ...
    <div className="file">File <span className="down-arrow">⯆</span></div>

    <div className="add-library">Add library</div>

    <div id="button-container">
      
      <div className="top-buttons" id="html">HTML</div>
      <div className="top-buttons" id="css">CSS</div>
      <div className="top-buttons" id="javascript">JavaScript</div>
      <div className="top-buttons" id="console">Console</div>
